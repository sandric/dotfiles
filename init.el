...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "white" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100 :width normal :foundry "PfEd" :family "Hack"))))
 '(font-lock-keyword-face ((t (:foreground "blue"))))
 '(highlight-symbol-face ((t (:background "pale turquoise"))))
 '(ivy-modified-buffer ((t (:inherit default :background "orange"))))
 ...
 '(region ((t (:background "violet" :distant-foreground "gtk_selection_fg_color"))))
